...
Definition id_gstep mc mc' : Prop :=
...
Inductive mstep mc mc' e i : Prop :=
  | silent (SILENT: e = None) (ID_GRAPH: id_gstep mc mc')
  | read a l v o 
  ...
  | fence a_r a_w o_r o_w (EVENT: e = Some (ProgramEvent.fence o_r o_w)) 
      (LABar: lab a_r = Arfence o_r) (LABaw: lab a_w = Awfence o_w) 
      (TIDar: thread a_r = i) (TIDaw: thread a_w = i) 
      mc_mid
      (GSTEPr: gstep (acts mc) (sb mc) (rmw mc) (rf mc) (mo mc) (sc mc)
           (acts mc_mid) (sb mc_mid) (rmw mc_mid) (rf mc_mid) (mo mc_mid) (sc mc_mid) a_r)
