...
Proof.
  inv STEP.
  inv STEP0; [inv STEP|inv STEP; inv LOCAL];
    try done; try inv LOCAL0; try inv LOCAL2; try destruct ord; try destruct ordw
...
Proof.
  ...
  { inv STEP1.
    inv STEP; [inv STEP0|inv STEP0; inv LOCAL]; try done
    ; by inv RD; try inv LOCAL0; try inv LOCAL1; exploit program_step_msg_forward; eauto.
  }
  des.

  inv STEP1. rewrite TID1 in TID. depdes TID.
  inv STEP; [inv STEP0|inv STEP0; inv LOCAL];
    inv RD; try inv LOCAL0; try inv LOCAL1; econs; eauto.
Qed.
...
Proof.
  ...
  { inv STEP1; inv STEP; [by inv STEP0|].
    inv STEP2. inv LOCAL; try done
    ; by inv RD; try inv LOCAL0; try inv LOCAL1; exploit program_step_msg_backward; eauto.
  }
  des.

  inv STEP2. inv LOCAL; inv RD; try inv LOCAL0; try inv LOCAL1; econs; eauto.
Qed.
...
Proof.
  ...
  { inv STEP1. inv STEP; [inv STEP0|inv STEP0; inv LOCAL]; try done. }
  ...
  admit.
  (* inv STEP1. inv STEP; [inv STEP1|inv STEP1; inv LOCAL]; try done; inv STEP0; inv LOCAL *)
...
Proof.
  ...
  { inv STEP2. inv STEP; [inv STEP0|inv STEP0; inv LOCAL]; try done. }
