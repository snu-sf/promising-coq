...
Module Thread.
  ...
  | step_read
      ...
      (STATE: State.step th1.(state) (Some (ThreadEvent.mem (MemEvent.read loc val ord))) st2)
  ...
  | step_write
      loc val ts released ord st2 commit2
      (STATE: State.step th1.(state) (Some (ThreadEvent.mem (MemEvent.write loc val ord))) st2)
  ...
  | step_update
      ...
      (STATE: State.step th1.(state) (Some (ThreadEvent.mem (MemEvent.update loc valr valw ord))) st3)
  ...
  | step_fence
      ord st2 commit2
      (STATE: State.step th1.(state) (Some (ThreadEvent.mem (MemEvent.fence ord))) st2)
  ...
  | step_None
      ...
      memory_step th1 mem1
                  (mk th1.(state) commit2 th1.(local))
  .

  Inductive declare_step (th1:t) (mem1:Memory.t) (th2:t) (mem2:Memory.t): Prop :=
  | declare_step_intro
      loc from to msg
      (STATE: th1.(state) = th2.(state))
      (COMMIT: Commit.le th1.(commit) th2.(commit))
      (LOCAL: Memory.declare loc from to msg th1.(local) th2.(local))
  ...
  | step_external
      ...
      (STATE: State.step st1 (Some (ThreadEvent.syscall e)) st2)
